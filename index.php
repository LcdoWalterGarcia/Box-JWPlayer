	...
	<div class="container">
		...
		<form id="action-form" action="action.php" method="POST" accept-charset="utf-8">
			...
			<div class="form-group">
			    <br>
				<label class="font-weight-bold">LINK BOX:</label>
				<input type="text" name="link" class="form-control" placeholder="Ex: https://app.box.com/index.php?rm=box_download_shared_file&shared_name=dcohl1rgoshk2my2tqsqf5065p7dt5ra&file_id=f_49436813346"this.select()" required>
			</div>
		...
		<label class="font-weight-bold">Example link BOX: https://app.box.com/s/dcohl1rgoshk2my2tqsqf5065p7dt5ra </label>
		<label class="font-weight-bold">Example link BOX STREAM: https://app.box.com/index.php?rm=box_download_shared_file&shared_name=dcohl1rgoshk2my2tqsqf5065p7dt5ra&file_id=f_49436813346 </label>
	</div><!-- /.container -->
	<?php
	}
